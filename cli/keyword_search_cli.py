...
def main() -> None:
    ...
    bm25_tf_parser.add_argument("limit", type=float, nargs='?', default=DEFAULT_SEARCH_LIMIT, help="Default search limit")
    ...
    match args.command:
        ...
        case "bm25search":
            print("Searching for:", args.query)
            search_results = search.bm25_search_command(args.query)
